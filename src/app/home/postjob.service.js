...
var PostJobService = (function () {
    ...
    PostJobService.prototype.extractData = function (res) {
        var body = res.json();
        return body || {};
    };
    PostJobService.prototype.handleError = function (error) {
        console.error(error);
